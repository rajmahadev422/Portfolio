...
const GROUPS = [
  ...
  },
  {
    ...
    bars: [
      ...
      { n: "REST APIs", p: 92 },
      { n: "GraphQL", p: 76 },
      { n: "PostgreSQL / MongoDB", p: 82 },
    ],
    tags: ["Prisma", "Socket.io", "JWT", "Docker"],
  },
  {
    label: "Languages",
    accent: "#059669",
    bars: [
      { n: "JavaScript ES2024", p: 96 },
      { n: "Python", p: 85 },
      { n: "C++", p: 80 },
      { n: "SQL", p: 83 },
    ],
  ...
  },
  {
    ...
    bars: [
      { n: "NumPy / Pandas", p: 84 },
      { n: "Scikit-learn", p: 77 },
      { n: "TensorFlow / Keras", p: 68 },
      { n: "NLP / HuggingFace", p: 71 },
    ],
    tags: ["Jupyter", "Matplotlib", "OpenCV", "FastAPI", "Pytorch", "SymPy"],
  },
];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-5">
          {GROUPS.map((g, gi) => (
            <div
              key={g.label}
              className="reveal p-7 border relative overflow-hidden transition-all duration-300"
              style={{
                background: "var(--card)",
                borderColor: "var(--border)",
                transitionDelay: `${gi * 0.09}s`,
              }}
            >
              <div
              ...
              <div className="space-y-3.5 mb-6">
                {g.bars.map((b) => (
                  <Bar key={b.n} n={b.n} p={b.p} accent={g.accent} />
                ))}
              </div>
              <div
        ...
        {/* Marquee */}
        <div
          className="reveal mt-14 overflow-hidden border-y py-4"
          style={{ borderColor: "var(--border)" }}
        >
          <div className="flex gap-10 animate-marquee whitespace-nowrap">
            {[
              ...
              <span
                key={i}
                className="font-mono text-[10px] tracking-[0.15em] uppercase flex items-center gap-10"
                style={{
                  fontFamily: "'IBM Plex Mono', monospace",
                  color: "var(--fg3)",
                }}
